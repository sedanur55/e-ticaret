...
class CategoryController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/{pid}", name="admin_category_show", methods={"GET"})
     */
     ...
     */
    public function edit(Request $request,CategoryRepository $categoryRepository,$id,$pid, Category $category): Response
    {
        $catlist=$categoryRepository->findBy(['parentid'=>0]);
